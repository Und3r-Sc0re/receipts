...
// Typical NIM free-tier latency is 15-30s; this is headroom for load
// spikes. Requires Fluid Compute enabled on the Vercel project (Settings >
// Functions) to take effect beyond the default 10s/60s caps.
